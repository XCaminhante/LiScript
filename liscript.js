LiScript = (function(){
  ...
  var translations = {
    ...
    'obj':function(){
      if (arguments.length < 2 || arguments.length%2 != 0) throw 'obj: invalid number of arguments'
    ...
    'let': function() {
      ...
      if (args.length < 2 || args.length%2 != 0) throw 'let: invalid number of arguments';
      for (var i=1, pairs=[]; i<arguments.length; i+=2)
        pairs.push([arguments[i-1],arguments[i]]);
